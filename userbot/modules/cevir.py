...
async def cevir(event):
    ...
    if islem == "foto" or islem == "photo":
        ...
        await event.client.send_file(event.chat_id, "sticker.png", reply_to=rep_msg, caption="[⚝ 𝑺𝑰𝑳𝑮𝑰 𝑼𝑺𝑬𝑹𝑩𝑶𝑻 ⚝](@silgiub) `ilə fotoya çevirildi.`")
        ...
        if efekt in EFEKTLER:
            ...
            await event.client.send_file(event.chat_id, "output.mp3", reply_to=rep_msg, caption="[⚝ 𝑺𝑰𝑳𝑮𝑰 𝑼𝑺𝑬𝑹𝑩𝑶𝑻 ⚝](@silgiub) `ilƏ efekt edildi.`")
